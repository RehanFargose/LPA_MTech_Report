...
Figure~\ref{fig:data_pipeline} illustrates the data flow and component interactions within the LPA system.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figs/DB_Detailed_Flow.pdf}
	\caption{End-to-End RAG Legal Data Pipeline Architecture[cite: 203].}
