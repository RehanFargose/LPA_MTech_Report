...
\begin{itemize}
    \item If the document contains any articles/code/IPC violations they should be tracked either based on the codes or based on statements or by using a vector db to match and extract relevant IPCs.
\end{itemize}
...
\begin{itemize}
    \item Make use of freely available datasets, vector DBs, LLM models and LLM APIs.
\end{itemize}
