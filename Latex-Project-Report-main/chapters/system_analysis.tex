...
\begin{enumerate}
	...
	\begin{itemize}
		\item PDFs are parsed using PyMuPDF/Fitz to extract raw text from judgments and evidence.
		\item Text is cleaned (noise removal, normalization) and segmented into logical units (facts, arguments, evidence).
		\item A LLM such as Deepseek R1(improved via DAPT) or Gemini is used to do initial synthesis of the documents.
	\end{itemize}
