...
\begin{itemize}
	...
	\item \textbf{Initial Synthesis Performance:} Precision, recall, and F1-score for legal entities (parties, dates, law sections). Target: F1-score $>$ 0.85 on validation set.
	...
	\item \textbf{Inference Efficiency:} Average processing time per case for the full pipeline (excluding offline preprocessing). Target: $<$ 2 minutes per case.
\end{itemize}
...
\begin{enumerate}
	\item \textbf{NER Accuracy Test:} Evaluate Dslim's NER output against manually annotated ground truth using precision, recall, and F1-score.
...
\begin{itemize}
	...
	\item \textbf{Risk:} High computational cost of Deepseek R1 8B/Gemini inference
